...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ProxyForge · Visual Nginx Infrastructure" },
      {
        name: "description",
        content:
          "Design, deploy, and operate Nginx-based infrastructure through a visual, node-based editor.",
      },
      { name: "author", content: "ProxyForge" },
      { property: "og:title", content: "ProxyForge · Visual Nginx Infrastructure" },
      {
        property: "og:description",
        content:
          "Visual-first Nginx control plane: build reverse proxies as node graphs, validated and reversible.",
      },
