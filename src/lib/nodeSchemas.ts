...
const SSL: NodeSchema = {
  ...
  fields: [
    ...
    { key: "certPath", label: "ssl_certificate", type: "text", placeholder: "/etc/ssl/fullchain.pem" },
    { key: "keyPath", label: "ssl_certificate_key", type: "text", placeholder: "/etc/ssl/privkey.pem" },
    {
      key: "protocols",
      label: "Protocols",
      type: "multiselect",
